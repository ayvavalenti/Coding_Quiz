    ...
    var qoa = [
        ...
        //q5
        {
            ...
            'The local element',
            'Global variable',
            'Both the local element and global variable',
            'none of these'],
...
// making the questions show up one at a time
var tQues = $('.questions').size;
var cQues =0;
...
$($questions.get(cQues)).fadeIn();

$('#next').click(function () {

    $($questions.get(cQues)).fadeOut(function(){
        cQues = cQues + 1;

        if (cQues == tQues) {
            var score = sum_values()
